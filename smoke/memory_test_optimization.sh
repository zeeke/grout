...
grcli route config set default rib4-routes 64 rib6-routes 64
...
grcli interface add vrf memorytestvrf rib4-routes 64 fib4-tbl8 64 rib6-routes 64 fib6-tbl8 64
